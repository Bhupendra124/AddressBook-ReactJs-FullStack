...
function AddressBookForm() {
    ...
    const [address, setAddress] = useState({ name: "", address: "", city: "", state: "", zip: "", phoneNo: "" });
    ...
    const handleSubmit = (event) => {
        ...
        setAddress({ name: "", address: "", city: "", state: "", zip: "", phoneNo: "" });
    }
                ...
                <form className="form" action="#" onSubmit={handleSubmit}>
                    ...
                    <div className="form-constrains">
                        ...
                        <div className="buttons-contact">
                            <Button type="submit" className="button button-text" id="submitButton" variant="contained" color="primary" size="medium" style={{ marginRight: "410px" }}>Add</Button>

                            
                            <Button type="reset" className="button button-text" id="resetButton" variant="contained"  color="secondary">Reset</Button>
                        </div>
                    </div>
                </form>
            </div>
